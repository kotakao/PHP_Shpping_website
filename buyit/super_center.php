...
<div class="home">
  ...
  <div class="all_commodity">
	  ...
	  <form action="account_control.php" method="post" id="form1" name="form1">
		<input type="submit" value="會員系統"  name='account data' style="width: 200px;height:70px;"/>
		</form>
	  <form action="commodity_control.php" method="post" id="form1" name="form1">
		<input type="submit" value="商品管理系統" name='Transaction record' style="width: 200px;height:70px;"/>
	</form>
	    <form action="discount.php" method="post" id="form1" name="form1">
		<input type="submit" value="優惠券管理" style="width: 200px;height:70px;"/>
	</form>
	  <form action="order_form.php" method="post" id="form1" name="form1">
		<input type="submit" value="訂單查看" style="width: 200px;height:70px;"/>
	</form>
